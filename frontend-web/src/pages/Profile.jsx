...
import { Bell, CircleHelp, Clock3, CreditCard, Gift, Heart, HelpCircle, History, Info, LogOut, MapPin, Package, Settings, ShieldCheck, Star, Tag } from "lucide-react";
...
export default function Profile() {
  ...
  const primary=[
    ...
    {icon:CreditCard,title:'Metode Pembayaran',subtitle:'QRIS, bank, dan dompet digital',onClick:go('/profil/detail?section=payment')},
