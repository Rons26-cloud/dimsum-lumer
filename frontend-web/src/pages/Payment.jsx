...
export default function Payment() {
  ...
  return <div className="min-h-dvh bg-[#f4f6f8] pb-28 text-slate-900">
    ...
    <main className="mx-auto max-w-xl space-y-4 px-3 py-4 sm:px-5">
      <PaymentHeaderCard selectedMethod={method === 'transfer' ? bank : method} orderCode={order.order_code || order.id} accountNumber={method === 'qris' ? '' : account} recipientName={seller} />
