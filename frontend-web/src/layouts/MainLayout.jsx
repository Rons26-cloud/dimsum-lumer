...
export default function MainLayout() {
  ...
  return (
    <div className="mobile-app-shell min-h-dvh flex flex-col bg-gray-50 overflow-x-clip [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
      {!hideHeader && <Navbar autoHide={pathname === "/"} />}
