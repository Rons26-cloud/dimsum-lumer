...
const TITLES = { "/": "Dashboard", "/produk": "Produk", "/flash-sale": "Flash Sale", "/kategori": "Kategori", "/banner-promo": "Banner Promo", "/promo": "Promo", "/pesanan": "Pesanan", "/pelanggan": "Pelanggan", "/wishlist": "Wishlist", "/lokasi-toko": "Lokasi Toko", "/pengaturan-map": "Pengaturan Map", "/jam-operasional": "Jam Operasional", "/statistik": "Statistik", "/laporan-penjualan": "Laporan Penjualan", "/maintenance": "Maintenance", "/pengaturan-umum": "Pengaturan Umum", "/akun-admin": "Akun Admin", "/notifikasi": "Notifikasi Admin", "/pusat-sistem": "Pusat Sistem & Audit", "/apk": "Aplikasi APK" };
